...
use App\Filament\Admin\Resources\MontenegroTourResource\Pages;
...
class MontenegroTourResource extends Resource
{
    protected static ?string $model = MontenegroTour::class;

    protected static ?string $navigationIcon = 'heroicon-o-globe-alt';
    protected static ?string $navigationGroup = 'Trips Management';
    protected static ?string $navigationLabel = 'Montenegro Trips';
    ...
    {
        return [
            'index' => Pages\ListMontenegroTours::route('/'),
            'create' => Pages\CreateMontenegroTour::route('/create'),
            'edit' => Pages\EditMontenegroTour::route('/{record}/edit'),
        ];
    }
}
